...
<body>
<div class="content">
    <form id="myForm" action="TeacherController" method="get">
            ...
            <c:otherwise>
                <table>
                    ...
                    <c:forEach var="grade_sort" items="${sessionScope.Grade_Sorts}">
                        <tr>
                            <td><label><input type="checkbox" name="selects"
                            value="${grade_sort.getCourse_num()},${grade_sort.getS_num()}"></label></td>
                            <td><label><input type="text" value="${grade_sort.getCourse_num()}"></label></td>
                            <td><label><input type="text" value="${grade_sort.getS_num()}"></label></td>
                            <td><label><input type="text" name="${grade_sort.getCourse_num()}_${grade_sort.getS_num()}"
                                              value="${grade_sort.getGrade()}"></label></td>
                        </tr>
                    </c:forEach>
                </table>
            </c:otherwise>
        ...
        <input style="display:inline-block;text-align:center;margin-top:5%;width:8%;height:4%;"
               type="button" onclick="submitForm('Submit_Query')" value="确认">
        <input style="display:inline-block;text-align:center;margin-top:5%;width:8%;height:4%;"
               type="button" onclick="submitForm('Submit_Delete')" value="删除">
        <input style="display:inline-block;text-align:center;margin-top:5%;width:8%;height:4%;"
               type="button" onclick="submitForm('Submit_Save')" value="保存">
