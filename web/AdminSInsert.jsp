...
<div class="content">
    <form id="myForm" action="AdminController" method="get">
        ...
        <input style="display:inline-block;text-align:center;margin-top:5%;width:8%;height:4%;"
               type="button" onclick="submitForm('Student_Add')" value="确认">
...
<script>
    ...
    function addRow(){
        ...
        cell71.innerHTML = '班级编号';
        let cell72 = row7.insertCell(1);
        cell72.innerHTML='<label><input type="text" name="selects" value=""></label></td>';
    }
</script>
</body>
</html>
